...
def returnn():
    global submitBtn, labelFrame, lbl1, bookInfo1, quitBtn, root, Canvas1, status
    ...
    try:
        ...
        messagebox.showinfo("Error", "Cant fetch book ids")
...
def returnBook():
    global bookInfo1, submitBtn, quitBtn, Canvas1, con, cur, root, labelFrame, lbl1
    ...
    # submit Button
    submitBtn = Button(root, text="Return", bg='#d1ccc0', command=returnn)
